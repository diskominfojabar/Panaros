#!/usr/bin/env python3
"""
Fetcher for StevenBlack/hosts - Fake News domains
Source: http://sbc.io/hosts/alternates/fakenews-only/hosts
"""
...
def fetch(config: dict = None) -> Set[str]:
    """
    Fetch fake news domains from StevenBlack hosts
    ...
    try:
        ...
        logger.info(f"Successfully fetched {len(domains)} domains from StevenBlack hosts (fakenews)")
        return domains
